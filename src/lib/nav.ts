...
import {
  LayoutDashboard, BookOpen, ClipboardList, Sparkles, CalendarDays, Users, BarChart3,
  User, Megaphone, FolderOpen, MessagesSquare, Target, Brain, Layers, Video, Trophy,
  type LucideIcon,
} from "lucide-react";

export type NavItem = { label: string; to: string; icon: LucideIcon; roles: AppRole[] };
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Quizzes", to: "/quizzes", icon: Brain, roles: ["student", "teacher", "admin"] },
  { label: "Flashcards", to: "/flashcards", icon: Layers, roles: ["student", "teacher", "admin"] },
  { label: "Live Classes", to: "/meetings", icon: Video, roles: ["student", "teacher", "admin"] },
  ...
  { label: "Leaderboard", to: "/leaderboard", icon: Trophy, roles: ["student", "teacher", "admin"] },
...
export const ROLE_LABEL: Record<AppRole, string> = { student: "Student", teacher: "Teacher", admin: "Admin" };
